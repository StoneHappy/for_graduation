#include "RCVulkanGraphicsPipline.h"
#include <array>
...
#include "navmesh_vert.h"
#include "navmesh_frag.h"
namespace GU
{
	...
	void createRCGraphicsPipeline(const std::vector<VkPipelineShaderStageCreateInfo>& shaderStages, const VkPipelineLayout& pipelineLayout, VkPipeline& graphicsPipeline)
	{
        ...
        auto bindingDescription = RCVertex::getBindingDescription();
        auto attributeDescriptions = RCVertex::getAttributeDescriptions();
	...
	{
        VkShaderModule vertexShader = createShader(GLOBAL_VULKAN_CONTEXT->logicalDevice, navmesh_vert, sizeof(navmesh_vert));
        VkShaderModule fragShader = createShader(GLOBAL_VULKAN_CONTEXT->logicalDevice, navmesh_frag, sizeof(navmesh_frag));
        ...
        createRCDescriptorSetLayout(GLOBAL_VULKAN_CONTEXT->rcDescriptorSetLayout);
